"""
Django settings for vchvideo project.
...
SECRET_KEY = 'django-insecure-k@jw22g*i-+&6&7!=uhlki3!=j7=%^yapt*l^%xyg@((!3$w)m'
...
INSTALLED_APPS = [
    ...
    'video_clips.apps.VideoClipsConfig',
    'django_cleanup',
    'easy_thumbnails',
    'bootstrap4',
...
WSGI_APPLICATION = 'vchvideo.wsgi.application'
